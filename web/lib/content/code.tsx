...
import { Code, chipFieldSurfaceClass, cn } from '@/components/ui-kit'
...
/**
 * Blog code block. Renders through the shared read-only `Code.Viewer` on the same `chipFieldSurfaceClass`

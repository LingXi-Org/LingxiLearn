...
/**
 * Apex host for every LingxiLearn-owned property, derived from the canonical site URL
...
/**
 * True only for links that leave LingxiLearn entirely. Relative hrefs, in-page anchors,
 * the apex host, and any LingxiLearn subdomain are first-party and keep

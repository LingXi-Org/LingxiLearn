...
export const LingxiCapabilityManifest = {
  ...
  files: { status: 'not_integrated', label: '文件', backend: null },
  tables: { status: 'not_integrated', label: '表格', backend: null },
  knowledge: { status: 'not_integrated', label: '知识库', backend: null },
  integrations: { status: 'not_integrated', label: '集成', backend: null },
  logs: { status: 'not_integrated', label: '日志', backend: null },

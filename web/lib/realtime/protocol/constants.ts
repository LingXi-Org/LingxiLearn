...
export type BlockOperation =
	(typeof BLOCK_OPERATIONS)[keyof typeof BLOCK_OPERATIONS];
...
export type BlocksOperation =
	(typeof BLOCKS_OPERATIONS)[keyof typeof BLOCKS_OPERATIONS];
...
export type EdgeOperation =
	(typeof EDGE_OPERATIONS)[keyof typeof EDGE_OPERATIONS];
...
export type EdgesOperation =
	(typeof EDGES_OPERATIONS)[keyof typeof EDGES_OPERATIONS];

export const SUBFLOW_OPERATIONS = {
	UPDATE: "update",
} as const;

export type SubflowOperation =
	(typeof SUBFLOW_OPERATIONS)[keyof typeof SUBFLOW_OPERATIONS];
...
export type VariableOperation =
	(typeof VARIABLE_OPERATIONS)[keyof typeof VARIABLE_OPERATIONS];
...
export type WorkflowOperation =
	(typeof WORKFLOW_OPERATIONS)[keyof typeof WORKFLOW_OPERATIONS];
...
export type SubblockOperation =
	(typeof SUBBLOCK_OPERATIONS)[keyof typeof SUBBLOCK_OPERATIONS];
...
export type OperationTarget =
	(typeof OPERATION_TARGETS)[keyof typeof OPERATION_TARGETS];
...
export type UndoRedoOperation =
	(typeof UNDO_REDO_OPERATIONS)[keyof typeof UNDO_REDO_OPERATIONS];

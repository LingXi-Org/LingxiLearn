...
export const KnowledgeBaseInfoSchema = z.object({
  ...
  embeddingDimension: z.number().int().default(0),
  embeddingModel: z.string().default("none"),
...
export const WorkspaceTableInfoSchema = z.object({
  ...
  columns: z.array(TableColumnInfoSchema),
  createdAt: z.string().nullable(),
  createdBy: z.string().default("lingxi-user"),
  description: z.string().default(""),
  folderId: z.string().nullable(),
  id: z.string(),
  locks: TableLocksInfoSchema,
  maxRows: z.number().int().default(100000),
  metadata: z.record(z.string(), z.unknown()),
  name: z.string(),
...
export const TableRowInfoSchema = z.object({
  createdAt: z.string().nullable(),
  data: z.record(z.string(), z.unknown()),
  executions: z.record(z.string(), z.unknown()),
  id: z.string(),
  position: z.number().int().default(0),
  updatedAt: z.string().nullable(),
...
export const WorkspaceFileInfoSchema = z.object({
  ...
  updatedAt: z.string().nullable(),
  uploadedAt: z.string().nullable(),
  uploadedBy: z.string().default("learner"),
  uploadedByEmail: z.string().default("learner@lingxilearn.local"),
  url: z.string(),

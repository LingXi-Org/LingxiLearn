      ...
      <header>
        <nav className='mx-auto flex w-full max-w-[1446px] items-center px-12 py-4 max-sm:px-5 max-lg:px-8'>
          <Link href='/' aria-label='灵犀智学首页' className='flex h-[30px] items-center gap-2'>
            <span className='flex size-6 items-center justify-center rounded-[7px] bg-[var(--text-primary)] text-[11px] font-semibold text-[var(--text-inverse)]'>灵</span>
            <span className='text-[13px] font-medium text-[var(--text-primary)]'>灵犀智学</span>
          </Link>
        </nav>
      </header>

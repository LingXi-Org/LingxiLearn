...
describe('parseBlocks legacy — thinking between top-level tools', () => {
  ...
  it('renders structured reasoning summaries while suppressing raw thinking text', () => {
    const segments = parseBlocks([
      {
        type: 'thinking',
        ...
        reasoningStep: {
          id: 'intent',
          title: 'Understand the learning goal',
          summary: 'The graph identified the learner’s intent.',
          status: 'complete',
        },
      },
      { type: 'thinking', content: 'another private delta' },
    ])

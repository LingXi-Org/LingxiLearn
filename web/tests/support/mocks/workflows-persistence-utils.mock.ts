 ...
 * @example
 * ```ts
 * import { workflowsPersistenceUtilsMockFns } from '@/tests/support'
 *
...
export const workflowsPersistenceUtilsMock = {
	blockExistsInDeployment:
		workflowsPersistenceUtilsMockFns.mockBlockExistsInDeployment,
	loadDeployedWorkflowState:
		workflowsPersistenceUtilsMockFns.mockLoadDeployedWorkflowState,
	...
	regenerateWorkflowStateIds:
		workflowsPersistenceUtilsMockFns.mockRegenerateWorkflowStateIds,
	undeployWorkflow: workflowsPersistenceUtilsMockFns.mockUndeployWorkflow,
	activateWorkflowVersion:
		workflowsPersistenceUtilsMockFns.mockActivateWorkflowVersion,
	activateWorkflowVersionById:
		workflowsPersistenceUtilsMockFns.mockActivateWorkflowVersionById,
	listWorkflowVersions:
		workflowsPersistenceUtilsMockFns.mockListWorkflowVersions,
};

 ...
 * @example
 * ```ts
 * import { stripeClientMock, stripeClientMockFns } from '@/tests/support'
 ...
 * @example
 * ```ts
 * import { stripePaymentMethodMock, stripePaymentMethodMockFns } from '@/tests/support'
...
export const stripePaymentMethodMockFns = {
	mockResolveDefaultPaymentMethod: vi.fn(async () => ({
		...
		collectionMethod: "charge_automatically" as
...
export const stripePaymentMethodMock = {
	resolveDefaultPaymentMethod:
		stripePaymentMethodMockFns.mockResolveDefaultPaymentMethod,

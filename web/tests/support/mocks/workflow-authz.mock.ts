 ...
 * by `@/lib/permissions/native/workflow`.
 */
...
/**
 * Controllable mocks for the `@/lib/permissions/native/workflow` entry.
 *
...
/**
 * Static mock module for `@/lib/permissions/native/workflow`.
 *
 * @example
 * ```ts
...
export const workflowAuthzMock = {
	...
	assertActiveWorkflowContext:
		workflowAuthzMockFns.mockAssertActiveWorkflowContext,

 ...
 * @example
 * ```ts
 * import { workflowsUtilsMockFns } from '@/tests/support'
 *
 ...
 *
 * `authorizeWorkflowByWorkspacePermission` moved to `@/lib/permissions/native/workflow`;
...
export const workflowsUtilsMock = {
	...
	createHttpResponseFromBlock:
		workflowsUtilsMockFns.mockCreateHttpResponseFromBlock,
	validateWorkflowPermissions:
		workflowsUtilsMockFns.mockValidateWorkflowPermissions,

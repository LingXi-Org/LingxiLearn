 ...
 * @example
 * ```ts
 * import { workflowsOrchestrationMockFns } from '@/tests/support'
 *
...
export const workflowsOrchestrationMock = {
	...
	performActivateVersion:
		workflowsOrchestrationMockFns.mockPerformActivateVersion,
	...
	performRevertToVersion:
		workflowsOrchestrationMockFns.mockPerformRevertToVersion,
	...
	performCreateWorkflow:
		workflowsOrchestrationMockFns.mockPerformCreateWorkflow,
	performUpdateWorkflow:
		workflowsOrchestrationMockFns.mockPerformUpdateWorkflow,
	performDeleteWorkflow:
		workflowsOrchestrationMockFns.mockPerformDeleteWorkflow,
};

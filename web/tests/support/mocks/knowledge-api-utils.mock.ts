 ...
 * @example
 * ```ts
 * import { knowledgeApiUtilsMockFns } from '@/tests/support'
 *
...
export const knowledgeApiUtilsMock = {
	...
	checkKnowledgeBaseWriteAccess:
		knowledgeApiUtilsMockFns.mockCheckKnowledgeBaseWriteAccess,
	checkDocumentWriteAccess:
		knowledgeApiUtilsMockFns.mockCheckDocumentWriteAccess,

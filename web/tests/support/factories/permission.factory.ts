...
export function createWorkflowRecord(
	options: WorkflowRecordFactoryOptions = {},
): WorkflowRecord {
...
export function createWorkflowAccessContext(options: {
	...
	return {
		...
		isWorkspaceOwner:
			userId && workspaceOwnerId ? workspaceOwnerId === userId : false,
	};
}
 ...
 */
export const ROLE_ALLOWED_OPERATIONS: Record<
	PermissionType,
	readonly SocketOperation[]
> = {

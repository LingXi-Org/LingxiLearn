...
export const HOME_GREETING = '今天要完成什么？'
 ...
 */
export const ANSWER_TEXT = '好的，我会调度一个智能体审查每个 PR，并创建 Jira 问题。'
...
export const KB_FILES: KbFile[] = [
  { name: '产品规格.pdf', size: '2.4 MB', icon: PdfIcon },
  { name: 'API 参考.md', size: '88 KB', icon: MarkdownIcon },
  { name: '支持常见问题.docx', size: '1.1 MB', icon: DocxIcon },
  { name: '定价.csv', size: '12 KB', icon: CsvIcon },
]

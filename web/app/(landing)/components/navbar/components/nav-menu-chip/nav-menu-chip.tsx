...
import { ChipChevronDown, chipContentLabelClass, chipVariants, cn } from '@/components/ui-kit'
 ...
 *
 * The grid is a plain two-column grid filled in reading order, matching the
 * product navigation's six-item, three-row Mega Menu layout.
 */

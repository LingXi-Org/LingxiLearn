 ...
 * (`feature-context-backdrop.jpg`) with the white demo window framed in front of it,
 * ready to hold a live platform interior (a chat platform loop or the workflows
 * editor loop). Extracted so every hero - the enterprise page included - reuses
 * the exact backdrop, window geometry (`aspect-[1080/620]` at 83.08% width),
 * and shadow treatment the enterprise page established.
 *
  ...
  return (
    <div className='relative h-full w-full'>
      <Image
        ...
        src='/landing/feature-context-backdrop.jpg'
      />
      <div className='-translate-x-1/2 -translate-y-1/2 absolute top-1/2 left-1/2 flex aspect-[1080/620] w-[83.08%] flex-col overflow-hidden rounded-[10px] bg-[var(--surface-1)] shadow-[0_0_0_1px_rgba(0,0,0,0.08),0_2px_6px_0_rgba(0,0,0,0.05),0_4px_42px_0_rgba(0,0,0,0.06)]'>
        <div className='relative flex-1'>
          <Image
            ...
            sizes='(max-width: 1024px) 83vw, 1080px'

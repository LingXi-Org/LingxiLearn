...
function Workspace() {
  ...
  const viewer = <SimResourcePanel task={task} events={events} initialTab={requestedTab} initialSkillId={requestedSkill} onBackToConversation={() => setMobileView("conversation")} />;
...
function parseResourceTab(value: string | null): ResourceTab {
  return value === "task-list" || value === "lesson-intro" || value === "lecture-deck" || value === "quiz" || value === "visual" || value === "skills" ? value : "canvas";
}

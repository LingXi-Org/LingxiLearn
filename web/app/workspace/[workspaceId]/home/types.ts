...
/**
 * Safe, user-facing reasoning metadata. Backends may emit private chain-of-
 * thought deltas, but only this deliberately summarized shape is allowed to
 * reach the transcript renderer.
 */
...
export const SUBAGENT_LABELS: Record<string, string> = {
  ...
  // LingxiGraph lanes. These are intentionally kept in Sim's shared label
  // table so the existing AgentGroup renderer owns their visual treatment.
  intent: 'Intent Agent',

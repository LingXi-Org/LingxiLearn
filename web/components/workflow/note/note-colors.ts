...
export const NOTE_COLOR_OPTIONS: readonly NoteColorOption[] = Object.values(
	NOTE_COLOR_OPTIONS_BY_ID,
);
...
export function isNoteColor(value: unknown): value is NoteColor {
	return (
		typeof value === "string" && Object.hasOwn(NOTE_COLOR_OPTIONS_BY_ID, value)
	);
}

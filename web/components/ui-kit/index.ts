 ...
 * the COMPONENT; the icon stays available from `@/components/ui-kit/icons`.
 */
 ...
 * COMPONENT, and the icon stays available from `@/components/ui-kit/icons`.
 */
export {
  CODE_LINE_HEIGHT_PX,
  Code,
 ...
 * always import the icon from `@/components/ui-kit/icons`. Rendering the
